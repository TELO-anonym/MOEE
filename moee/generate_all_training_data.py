...
"""
from egreedy.util import generate_training_data as gtd
...
# problem_names = ["LEVY_2", "LEVY_10"]
# problem_names = ["ACKLEY_2", "ACKLEY_10"]
# problem_names = ["ACKLEY_10"]
# problem_names = ["ACKLEY_20"]
problem_names = ["GRIEWANK_2", "GRIEWANK_10", "GRIEWANK_20"]
...
# print(
#     "Now generating PitzDaily data, this will take approximately 17 hours"
